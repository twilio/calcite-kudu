...
public class InListPredicateTest {
  ...
  public void stringTranslation() {
    ...
    final InListPredicate predicate = new InListPredicate(0,
        Arrays.<Object>asList("string", Integer.valueOf(4), Boolean.TRUE));
  ...
  public void booleanTranslation() {
    ...
    final InListPredicate predicate = new InListPredicate(0, Arrays.<Object>asList(Boolean.TRUE));
  ...
  public void int16Translation() {
    ...
    assertEquals(KuduPredicate.newInListPredicate(columnSchema,
        ...
        Arrays.asList(Short.valueOf((short) -19), Short.valueOf((short) -15), Short.valueOf((short) -1))),
        predicate.toPredicate(columnSchema, true));
  }
  ...
  public void int32Translation() {
    ...
    assertEquals(KuduPredicate.newInListPredicate(columnSchema,
        ...
        Arrays.asList(Integer.valueOf(-19), Integer.valueOf(-15), Integer.valueOf(-1))),
        predicate.toPredicate(columnSchema, true));
  }
  ...
  public void int64Translation() {
    ...
    assertEquals(KuduPredicate.newInListPredicate(columnSchema,
        ...
        Arrays.asList(Long.valueOf(-19L), Long.valueOf(-15L), Long.valueOf(-1L))),
        predicate.toPredicate(columnSchema, true));
  }
  ...
  public void decimalTranslation() {
    ColumnSchema columnSchema = new ColumnSchema.ColumnSchemaBuilder("fielda", Type.DECIMAL)
        .typeAttributes(new ColumnTypeAttributes.ColumnTypeAttributesBuilder().build()).build();
    final InListPredicate predicate = new InListPredicate(0,
        Arrays.<Object>asList(BigDecimal.valueOf(0L), BigDecimal.valueOf(14L), BigDecimal.valueOf(18L)));

    assertEquals(
        KuduPredicate.newInListPredicate(columnSchema,
            Arrays.asList(BigDecimal.valueOf(0L), BigDecimal.valueOf(14L), BigDecimal.valueOf(18L))),
        predicate.toPredicate(columnSchema, false));
  }
  ...
  public void microsecsTranslationLong() {
    ...
    assertEquals(KuduPredicate.newInListPredicate(columnSchema, Arrays.asList(july11, sept11)),
        predicate.toPredicate(columnSchema, false));

    assertEquals(
        KuduPredicate.newInListPredicate(columnSchema,
            Arrays.asList(REVERSE_TIMESTAMP_EPOCH - july11, REVERSE_TIMESTAMP_EPOCH - sept11)),
        predicate.toPredicate(columnSchema, true));
  }
  ...
  public void microsecsTranslationTimestamp() {
    ...
    assertEquals(
        KuduPredicate.newInListPredicate(columnSchema,
            Arrays.asList(july11.toInstant().toEpochMilli(), sept11.toInstant().toEpochMilli())),
        predicate.toPredicate(columnSchema, false));
