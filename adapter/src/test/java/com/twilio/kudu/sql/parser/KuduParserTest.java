...
public class KuduParserTest {
  ...
  private SqlParser getSqlParser(Reader source, UnaryOperator<SqlParser.ConfigBuilder> transform) {
    SqlParser.ConfigBuilder configBuilder = SqlParser.configBuilder().setParserFactory(KuduSqlParserImpl.FACTORY);
  ...
  public void testCreateTable() {
    String ddl = "CREATE TABLE \"my_schema.MY_TABLE\" (" + "STRING_COL VARCHAR "
        ...
        + "PARTITION BY HASH (STRING_COL) PARTITIONS 17 " + "TBLPROPERTIES ('kudu.table.history_max_age_sec'=7200)";
