...
public class ScannerMetrics {
  ...
  /**
   * @return the object for the specified fieldName if the field exists in
   *         AsyncKuduScanner and if the type of the object matches expectedClass
   */
  ...
  public String toString() {
    return "ScanMetrics{" + "table='" + table + '\'' + ", tablet='" + tablet + '\'' + ", scannerId='" + scannerId + '\''
        + ", startPrimaryKey='" + startPrimaryKey + '\'' + ", endPrimaryKey='" + endPrimaryKey + '\'' + ", metrics="
        + metrics + '}';
  }
}
